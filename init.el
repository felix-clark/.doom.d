...
(doom! :input
       ...
       :completion
       (company)           ; childframe can look malformed, perhaps w/ lsp-ui interaction. consider +tng for tab-only completion.
       ...
       ;; lsp may preclude tide, which may have better features. However, lsp allows DAP debugging.
       ...
       ;; (org +dragndrop +journal +present +roam)               ; organize your plain life in plain text
       (org +dragndrop +journal +present)               ; organize your plain life in plain text
