;;; org-trello.el --- Org + Trello integration
;;; Code:
...
(use-package! org-trello
  :after org
  :config
  ;; org-trello files can be specified like so:
  ;; (custom-set-variables '(org-trello-files '("path/to/file0.org" "path/to/file1.org")))
  ;; do the mapping using doom's map macros.
  ;; (custom-set-variables '(org-trello-current-prefix-keybinding "<leader> m x"))
